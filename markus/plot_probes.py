...
from markus.utils.compatibility import *
...
def load_probe_results():
    ...
    path = lambda ha, rl : f'markus/data/probe_results/gpt_sw3_356m_{ha}_reg_lambda_{rl}.json'
...
def make_big_plot():
    ...
    fig.savefig('big_fig.png', bbox_inches='tight', dpi=400)