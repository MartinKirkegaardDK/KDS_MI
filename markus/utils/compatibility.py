...
class FilePaths:
    ...
    antibiotic_folder = lambda lan: f'markus/data/antibiotic/{lan}.txt'
    bible_folder = lambda lan: f'markus/data/bible/{lan}.xml'
    ...
    def steering_vectors(cls, lan, hook_address, model):
        _steering_vectors = {
            GPTNeoXForCausalLM: f'markus/steering_vectors/pythia/{lan}/combined/{hook_address}.pt',
            GPT2LMHeadModel: f'markus/steering_vectors/gpt-sw3/{lan}/combined/{hook_address}.pt'
        }
