...
from src.utils.new.compatibility import HookAddress
import torch.nn.functional as F
from src.utils.old.text_visualization import plot_text_viz
...
def main(model_name:str, model_name_temp:str, text:str,language_arg:str,layer:int):
    ...
    path = f"steering_vectors/average_activation_vectors/{model_name_temp}"
