...
class FilePaths:
    ...
    def steering_vectors(cls, lan, hook_address, model):
        _steering_vectors = {
            GPTNeoXForCausalLM: f'steering_vectors/steering_vectors/pythia/{lan}/combined/{hook_address}.pt',
            GPT2LMHeadModel: f'steering_vectors/steering_vectors/gpt-sw3/{lan}/combined/{hook_address}.pt'
        }
