...
def plot_cool(df:pd.DataFrame):
    ...
    #plt.tight_layout()
    plt.savefig(f"results/figures/scandeval/scandeval_plots.png",bbox_inches='tight')
...
def plot(df:pd.DataFrame, with_steering:bool):
    ...
    plt.tight_layout()
    plt.savefig(f"results/figures/scandeval/{var}_steering_nlu.png",bbox_inches='tight')
    #plt.show()
    ...
    plt.tight_layout()
    plt.savefig(f"results/figures/scandeval/{var}_steering_nlg.png",bbox_inches='tight')
    #plt.show()
