...
from src.utils.new.data import load_antibiotic_data, FilePaths
from src.utils.new.hooking import get_activations

from src.utils.new.compatibility import Hookpoints, ModelConfig, HookAddress
...
def main(model_url, device, layers=None, hook_addresses=None, out_file=None, layers_per_fig=6, max_batches=10):
    ...
    for i in range(num_figs):
        ...
        if out_file:
            fig.savefig(f'results/figures/PCA/fig_{i+1}_{out_file}', transparent=False, dpi=300)
